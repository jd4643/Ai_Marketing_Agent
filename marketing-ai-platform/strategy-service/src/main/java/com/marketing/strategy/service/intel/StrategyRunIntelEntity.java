...
public class StrategyRunIntelEntity {
    ...
    public String getChosenTemplateKey() {
        return chosenTemplateKey;
    }

    public void setChosenTemplateKey(String chosenTemplateKey) {
        this.chosenTemplateKey = chosenTemplateKey;
    }

    public String getDecisionPathJson() {
        return decisionPathJson;
    }

    public void setDecisionPathJson(String decisionPathJson) {
        this.decisionPathJson = decisionPathJson;
    }
    ...
    public String getSimilarityMatchJson() {
        return similarityMatchJson;
    }

    public void setSimilarityMatchJson(String similarityMatchJson) {
        this.similarityMatchJson = similarityMatchJson;
    }
